...
use super::{EventStateStream, event_state_map_stream::EventStateMapStream, event_state_split_stream::{self, EventStateSplitLeft, EventStateSplitRight, bounded, unbounded}};
#[cfg(realtime)]
...
pub trait EitherStateStreamExt<L, R>: EventStateStream<Event=Either<L, R>>{
    ...
    fn split_bounded(self, buffer_size: usize) -> (
