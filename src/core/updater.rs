...
use futures::Future;
use std::pin::Pin;
use super::{event_factory::EventFactory, event::{Event, ScheduleEvent}};


pub struct InitResult<U: Updater> {
    pub new_updater: U,
    pub new_events: Vec<ScheduleEvent<U::In, U::Internal>>,
    pub emitted_events: Vec<Event<U::Out>>,
}
...
pub struct UpdateResult<U: Updater> {
    ...
    pub expired_events: Vec<ScheduleEvent<U::In, U::Internal>>,
    pub new_events: Vec<ScheduleEvent<U::In, U::Internal>>,
    pub emitted_events: Vec<Event<U::Out>>,
}
